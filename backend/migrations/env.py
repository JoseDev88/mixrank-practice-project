# --- Path bootstrap so "from app.main import Base" works without PYTHONPATH ---
import os, sys
...
# Tell Alembic where your models live for autogenerate
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            # Optional niceties for autogenerate diffs:
            compare_type=True,
